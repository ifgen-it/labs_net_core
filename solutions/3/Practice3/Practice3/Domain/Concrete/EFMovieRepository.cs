...
namespace Practice3.Domain.Concrete
{
    public class EFMovieRepository : IMovieRepository
    {
        ...
        public IQueryable<MovieActor> MovieActors => db.MovieActors;
        ...
        public bool MovieActorExists(int movieId, int actorId)
        {
            return db.MovieActors.Any(ma => ma.MovieId == movieId && ma.ActorId == actorId);
        }
    }
}
